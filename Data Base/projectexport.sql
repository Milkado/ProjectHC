...
Insert into PROJECTHC.GRUPO (ID_GRUPO,CARGA_MAXIMA,DESCRICAO) values ('2','100','Participação em eventos de extensão acadêmica');
...
SET DEFINE OFF;
Insert into PROJECTHC.MODALIDADE (ID_MODALIDADE,PONT_MAXIMA,TIPO_PONT,ID_GRUPO,NOME,COMPROVANTE) values ('1','40','CH da discplica','1','Disciplinas Eletivas e/ou nivelamento','Certificado, Declaração ou
